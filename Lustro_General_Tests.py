...
try:
    from lustro_rust import evaluate_baseline_inplace
except ImportError:
...
class LustroAuditSuite:
    ...
    def run_test(self, test_id):
        ...
        # B32 orchestrates Rust calls directly.
        pool_tests = {"B2", "B13", "B16", "B22", "B51", "B53"}
    ...
    def run_all(self):
        print(f"\n{'=' * 65}")
        print(f"{'LUSTRO CORE V1 - INTERNAL AUDIT':^65}")
        print(f"{'=' * 65}\n")
...
# ==========================
    ...
    def _run_b2(self, pool):
        ...
        for chunk in chunks:
            ...
            evaluate_baseline_inplace(flat)
...
# and an EVT-corrected deviation score.
    ...
    def _run_b13(self, pool):
        import math
        from lustro_rust import b13_st_pairs_meta, b13_st_layout
